    ...
    <div className="min-h-screen font-sans overflow-x-hidden" style={{ background: '#fafafa' }}>
      ...
      >
        <div className="flex items-center gap-2.5">
          <img src={`${import.meta.env.BASE_URL}logo.svg`} alt="Rescate Sabor" className="w-10 h-9" />
      ...
      >
        ...
        <div className="animate-scaleIn">
          <div className="bg-white rounded-3xl p-6 shadow-2xl mb-8 inline-block animate-float" style={{ animationDuration: '5s' }}>
            <img src={`${import.meta.env.BASE_URL}logo.svg`} alt="Rescate Sabor" className="w-36 h-28 mx-auto" />
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <div className="inline-block mb-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-4 inline-block">
              <img src={`${import.meta.env.BASE_URL}logo.svg`} alt="Rescate Sabor" className="w-20 h-16 mx-auto" />
            </div>
          </div>
      ...
      <footer className="bg-gray-950 py-12 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-8">
            <div className="flex items-center gap-2.5">
              <img src={`${import.meta.env.BASE_URL}logo.svg`} alt="Rescate Sabor" className="w-9 h-8" />
              <span className="font-black text-lg tracking-tight">
                <span style={{ color: O }}>Rescate</span>
